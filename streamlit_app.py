...
if selector == "Bread":
    ...
    st.session_state.time = option

    if st.session_state.time == "Casper":
        if type == "All Materials":
            wheatTotal = formatNumber(10000000 * num)
            carrotTotal = formatNumber(10000000 * num)
            potatoTotal = formatNumber(10000000 * num)
            beetrootTotal = formatNumber(10000000 * num)
            coalTotal = formatNumber(25000000 * num)
            ironTotal = formatNumber(25000000 * num)
            spruceTotal = formatNumber(500000000 * num)
            auburnTotal = formatNumber(200000000 * num)
            carmineTotal = formatNumber(200000000 * num)
            ceruleanTotal = formatNumber(200000000 * num)
            azureTotal = formatNumber(200000000 * num)
            twilightTotal = formatNumber(500000000 * num)
            abyssTotal = formatNumber(500000000 * num)
            enderTotal = formatNumber(500000000 * num)
            voidTotal = formatNumber(500000000 * num)
    ...
    elif st.session_state.time == "Default":
        if type == "All Materials":
